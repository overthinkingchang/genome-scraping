...
def genome_scraping(sequence):
    if (check_exists(sequence)): 
        driver.find_element(By.XPATH, "//*[@id='main']/div[3]/label[1]/input").click()
        driver.find_element(By.ID, 'search-btn').click()
        driver.implicitly_wait(20) 
        ...
        Pos_value_grch37 = entries_grch37[1].find_element(By.TAG_NAME, 'td').text
        driver.find_element(By.XPATH, "//*[@id='main']/div[3]/label[2]/input").click()
        driver.find_element(By.ID, 'search-btn').click()
        driver.implicitly_wait(20)
